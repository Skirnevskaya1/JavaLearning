...
//
//        start_story = new Situation("Оружие.","У вас обязательно должно быть оружие для защиты и охоты, осмотритесь вокруг, что можно придумать: ",3,0,0,0);
//        start_story.direction[0] = new Situation("Копье", "Можно сделать дубинку и простейшее копье с каменным наконечником.",0, 0,+25,0);
//        start_story.direction[1] = new Situation("Нож.", "Воспользуюсь тем, что есть, ведь у меня есть нож.",0, 0,0,0);
//        start_story.direction[2] = new Situation("Без оружия", "Я верю в свои собственные силы, ведь я ходил 2,5 месяца в тренажерный зал! Я верю в успех и в себя!",0, 0,0,0);
//        current_situation = start_story;
